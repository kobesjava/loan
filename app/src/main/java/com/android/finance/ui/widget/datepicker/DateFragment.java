...
public class DateFragment extends Fragment {
    ...
    public static final DateFragment newInstance(int theme, int year, int month,
                                                 int day, Date minDate, Date maxDate, boolean isHideDay) {
        ...
        b.putBoolean("isHideDay", isHideDay);
        f.setArguments(b);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        boolean initialIsHideDay = getArguments().getBoolean("isHideDay", false);
        ...
        View v = localInflater.inflate(R.layout.fragment_slidedatetimepicker_date, container, false);

        mDatePicker = (CustomDatePicker) v.findViewById(R.id.datePicker);

//        mDatePicker.setMonth();
...
//        mDatePicker.setMax();
        ...
        if (initialIsHideDay) mDatePicker.hideDay();
