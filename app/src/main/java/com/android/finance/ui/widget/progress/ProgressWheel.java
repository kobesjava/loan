package com.android.finance.ui.widget.progress;
...
public class ProgressWheel extends View {
    ...
    private void parseAttributes(TypedArray a) {
        ...
        circleRadius = (int) a.getDimension(R.styleable.LProgressWheel_matProg_circleRadius, circleRadius);
        ...
        float baseSpinSpeed = a.getFloat(R.styleable.LProgressWheel_matProg_spinSpeed, spinSpeed / 360.0f);
        spinSpeed = baseSpinSpeed * 360;

        barSpinCycleTime = a.getInt(R.styleable.LProgressWheel_matProg_barSpinCycleTime, (int) barSpinCycleTime);
